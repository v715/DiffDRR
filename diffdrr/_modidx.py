...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'diffdrr.data': { 'diffdrr.data.load_example_ct': ('api/data.html#load_example_ct', 'diffdrr/data.py'),
            ...
            'diffdrr.drr': { 'diffdrr.drr.DRR': ('api/drr.html#drr', 'diffdrr/drr.py'),
                             ...
                             'diffdrr.drr.DRR.isocenter_to_origin': ('api/drr.html#drr.isocenter_to_origin', 'diffdrr/drr.py'),
                             'diffdrr.drr.DRR.origin_to_isocenter': ('api/drr.html#drr.origin_to_isocenter', 'diffdrr/drr.py'),
